...
export const experiences = [
  ...
  },
  {
    ...
    desc: "During my role as a Manual QA Intern, I performed manual testing of web applications to identify and document bugs, UI inconsistencies, and performance issues. I validated API responses using Postman to ensure endpoint functionality and reliability. This internship provided me with practical exposure to the Software Development Life Cycle (SDLC), bug tracking tools, and core quality assurance processes.",
    // skills: [
    //   "Leadership",
...
export const education = [
  {
    ...
    date: "2025",
    grade: "",
    desc: "Completed GUVI’s Full Stack Development program with hands-on MERN projects.",
    link: "https://drive.google.com/file/d/1-LDsPBjkUKlUuF17JmdQRMbNHjVHKE2F/view?usp=sharing"
  },
...
export const projects = [
  ...
  
  {
    ...
    title: "Pet Finds",
    description:
      "A MERN-based Pet Adoption platform designed to connect stray or abandoned pets with potential adopters. Developed secure RESTful APIs using Node.js and Express.js for handling pet listings, user authentication, and adoption requests. The platform provides an easy-to-use interface for users to browse pets, submit adoption interest, and manage profiles — helping streamline the pet adoption process.",
    image:
      "/pics/PetFinds.png",
    tags: [
       "HTML",
